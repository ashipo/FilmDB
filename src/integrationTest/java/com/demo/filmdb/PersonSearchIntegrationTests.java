...
public class PersonSearchIntegrationTests {
    ...
    @MethodSource("com.demo.filmdb.PersonSearchIntegrationTests#nameFilterAndCountProvider")
    ...
    @MethodSource("com.demo.filmdb.PersonSearchIntegrationTests#bornAfterAndCountProvider")
    ...
    @ParameterizedTest(name = "\"{0}\", expect to find {1} people")
    @MethodSource("com.demo.filmdb.PersonSearchIntegrationTests#bornBeforeAndCountProvider")
