...
public class FilmSearchIntegrationTests {
    ...
    @MethodSource("com.demo.filmdb.rest.FilmSearchIntegrationTests#titleFilterAndCountProvider")
    ...
    @MethodSource("com.demo.filmdb.rest.FilmSearchIntegrationTests#releaseAfterAndCountProvider")
    ...
    @ParameterizedTest(name = "\"{0}\", expect to find {1} films")
    @MethodSource("com.demo.filmdb.rest.FilmSearchIntegrationTests#releaseBeforeAndCountProvider")
